...
public class MainTest4 {
	...
	public void test1WithNoneClass() throws Throwable {
		...
		user.put("datas", datas);
		param3.put(user, user);
		Map<Object, Object> response = Map.class.cast(this.generic.invoke(new Service("com.kepler.TestApp4", "0.0.1-generic"), "test1", null, param1, param2, param3));
		Map<String, Object> key = Map.class.cast(response.keySet().iterator().next());
		Assert.assertEquals(1, key.get("age"));
		Assert.assertEquals(10L, key.get("level"));
		Assert.assertEquals("user", key.get("name"));
	...
	public void test3WithNoneClass() throws Throwable {
		...
		user.put("datas", datas);
		param3.put(user, user);
		Map<Object, Object> response = Map.class.cast(this.generic.invoke(new Service("com.kepler.TestApp4", "0.0.1-generic"), "test2", null, param1, param2, param3));
		Map<String, Object> key = Map.class.cast(response.keySet().iterator().next());
		Assert.assertEquals(1, key.get("age"));
		Assert.assertEquals(10L, key.get("level"));
		Assert.assertEquals("user", key.get("name"));
