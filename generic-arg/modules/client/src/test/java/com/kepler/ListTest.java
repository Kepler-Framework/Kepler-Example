...
public class ListTest {
	...
	public void test2() throws Throwable {
		ListArg roles = new ListArg().add(new ObjectArg("com.kepler.list.Role").put("nums", Arrays.asList("A", "B", "C")));
	...
	public void test3() throws Throwable {
		...
		ListArg cities = new ListArg().add(city1).add(city2);
		ListArg roles = new ListArg().add(new ObjectArg("com.kepler.list.Role").put("nums", Arrays.asList("A", "B", "C")).put("cities", cities));
