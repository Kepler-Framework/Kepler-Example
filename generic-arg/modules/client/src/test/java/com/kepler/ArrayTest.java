...
public class ArrayTest {
	...
	public void test2() throws Throwable {
		ArrayArg roles = new ArrayArg("com.kepler.array.Role").add(new ObjectArg("com.kepler.array.Role").put("nums", new String[] { "A", "B", "C" }));
	...
	public void test3() throws Throwable {
		...
		ArrayArg cities = new ArrayArg("com.kepler.array.City").add(city1).add(city2);
		ArrayArg roles = new ArrayArg("com.kepler.array.Role").add(new ObjectArg("com.kepler.array.Role").put("nums", new String[] { "A", "B", "C" }).put("cities", cities));
