...
public class MainTest {
	...
	public void test() throws Throwable {
		...
		dept.put("leaders", new ArrayArg("com.kepler.domain.impl.UserImpl").put(new ObjectArg("com.kepler.domain.impl.UserImpl").put("id", 0L)).put(new ObjectArg("com.kepler.domain.impl.UserImpl").put("id", 1L)));
		// User1 
